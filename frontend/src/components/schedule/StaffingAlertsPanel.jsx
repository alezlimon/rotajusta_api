    ...
    return (
      <section className="rounded-2xl border border-rose-400/20 bg-rose-500/5 p-4">
        <div className="flex items-center justify-between gap-2">
          <h2 className="text-base font-semibold text-rose-100">Cobertura</h2>
        ...
        <ul className="mt-3 space-y-1 text-xs text-slate-200">
          {reasonBuckets.map(([reason, total]) => (
            <li key={reason} className="flex items-center justify-between rounded-lg border border-white/10 bg-slate-900/60 px-2 py-1">
  ...
  return (
    <section className="rounded-2xl border border-rose-400/20 bg-rose-500/5 p-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h2 className="text-lg font-semibold text-rose-100">Alertas de cobertura</h2>
