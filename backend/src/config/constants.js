...
const SCHEDULE_CONFIG = Object.freeze({
  ...
  MIN_YEAR: 2024,
  MAX_YEAR: 2099,
  FAIRNESS_HIGH_MAX_DIFF: 20,
  FAIRNESS_MEDIUM_MAX_DIFF: 40,
  SOFT_WEEKLY_HOURS_START: 30,
  SOFT_WEEKLY_HOURS_GROWTH: 1.45,
  PREFERRED_FREE_DAYS_PER_WEEK: 2,
  HARD_MIN_FREE_DAYS_PER_WEEK: 1,
  WEEKLY_WARNING_HOURS: 35,
  WEEKLY_HOURS_LIMIT: 40,
  MONTHLY_WARNING_RATIO: 0.85,
